  ...
  return (
    ...
    >
      <div className="p-4 pb-32">
        ...
        {/* Fixed bottom buttons - Updated with safe area handling */}
        <div className="flex items-center gap-4 pt-6 fixed bottom-0 left-0 right-0 bg-white p-4 pb-safe shadow-lg z-10">
          <Button 
            variant="outline" 
            className="flex-1"
